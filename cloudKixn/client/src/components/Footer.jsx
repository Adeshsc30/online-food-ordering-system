    ...
    <div>
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        ...
        <nav>
          ...
          <a className="link link-hover">shah.adesh30@gmail.com</a>
          <a className="link link-hover">aadarshshahi34@gmail.com</a>
          <a className="link link-hover">+977 9840789858</a>
          <a className="link link-hover">+977 9840789859</a>
        </nav>
      </footer>
        <hr />
